...
from wattsup.wattwise_streak import maybe_record_wattwise_slack_opt_in
...
def slack_user_message_complete(
    ...
    try:
        maybe_record_wattwise_slack_opt_in(settings, user_id, user_text)
    except Exception:
        _log.exception("wattwise streak hook failed")
